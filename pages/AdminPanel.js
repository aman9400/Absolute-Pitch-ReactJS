  ...
  return (
    <Grid container spacing={0} className={classes.containerBox}>
      ...
      <Grid
        ...
        className={classes.leftSection}
      ></Grid>
      <Grid item xs={12} md={3} sm={12} sx={12} className={classes.leftSection}>
        <Grid container spacing={0} className={classes.containerBox}>
          <Grid
            item
            xs={12}
          ...
          >
            <a href="https://www.instagram.com/" target="new" title="Soundcloud">
              <Image
                src={InstaGram}
                alt="Picture of the author"
                width="500"
          ...
          <Grid
            ...
            style={{ height: "70px", padding: "3px" }}
          >
            <a href="https://twitter.com/i/flow/login" target="new" title="Soundcloud">
              <Image
                src={Twitter}
                alt="Picture of the author"
                width="500"
